...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let starsImageView = UIImageView(image: UIImage(named: "stars.png"))
        let auroraImageView = UIImageView(image: UIImage(named: "aurora.png"))
        
        //設定極光顯示的位置及大小
        auroraImageView.frame = CGRect(x: 5, y: 330, width: 370, height: 410)
        
        //星星的大小等於極光的尺寸
        starsImageView.frame = auroraImageView.bounds
        
        //設定極光的遮罩(mask)為星星的圖片
        auroraImageView.mask = starsImageView
        
        //設定極光為 view 的 subvie
        view.addSubview(auroraImageView)
